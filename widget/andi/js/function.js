...
原弹窗提示*/
         ...
         api.closeWin({
            ...
            api.openWin({
                 name: 'h5',
                 url: 'http://www.2020123.xyz/index/index/index',
                });
*/
							api.openWin({
...
*/
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://www.2020123.xyz/index/dianka/index'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
					...
					if(ret) {
						if(ret.code == 0) {
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://www.2020123.xyz/index/getmoney/tixian.html'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
...
*/
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://www.2020123.xyz/index/user/pass'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
      ...
      if (ret.code == 1) {
           api.toast({
              ...
              api.openWin({
                  ...
                  url: './daili_guanli_win.html',
                  delay: 100,
                  pageParam:{url:'http://www.2020123.xyz/index/getmoney/tixian.html'},
                  bgColor: 'rgba(0,0,0,0)'
              });
         }else {
         api.hideProgress();
					...
					if(ret) {
						if(ret.code == 0) {
							...
							api.openWin({
								...
								delay: 300,
								pageParam: {
									url: 'http://www.2020123.xyz/index/vip/index'
								},
								bgColor: 'rgba(0,0,0,0)'
							});
       ...
       /*       alert('登录成功');
             ...
             api.toast({
                ...
                api.openWin({
                    ...
                    url: './daili_guanli_win.html',
                    delay: 100,
                    pageParam:{url:'http://www.2020123.xyz/index/user/index.html'},
                    bgColor: 'rgba(0,0,0,0)'
                });
